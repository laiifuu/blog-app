...
RSpec.describe User, type: :model do
  ...
  it 'User\'s most recent post should be Post 4' do
    user = User.create(name: 'Sombody', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Im a Jhon Doe')
    Post.create(author: user, title: 'Post 1', text: 'Joey doesn\'t share food.')
    Post.create(author: user, title: 'Post 2',
                text: 'And that ladies and gents is how you get away from all your troubles.')
    Post.create(author: user, title: 'Post 3', text: 'Joey still doesn\'t share food.')
    Post.create(author: user, title: 'Post 4', text: 'Lets do this.')
